...
public class LetterI extends Letter {
    ...
    public LetterI(double currentLetterX, double currentLetterY) {
        super("I");
        SVGPath svgPath = new SVGPath();
        svgPath.setContent("M-78 271 c0 -5 13 -11 29 -14 29 -6 29 -6 36 -100 4 -52 4 -122 0 -156 -7 -59 -8 -61 -36 -61 -37 0 -38 -18 -2 -25 16 -3 44 -10 64 -15 20 -6 39 -10 43 -10 3 0 6 81 6 180 l0 181 30 6 c61 12 27 23 -70 23 -55 0 -100 -4 -100 -9z");
