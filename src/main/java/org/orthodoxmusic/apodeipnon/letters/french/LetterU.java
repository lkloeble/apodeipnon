...
public class LetterU  implements Letter {
    ...
    public double getCurrentX() {
        return svgPath.getTranslateX() + U_HORIZONTAL_SPACE;
    }

    @Override
    public int getGraphicalSize() {
        return (int)(svgPath.getBoundsInLocal().getWidth()*getSvgPath().getScaleX()) + U_HORIZONTAL_SPACE;
    }
