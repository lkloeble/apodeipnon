...
public class PDFMerger {
    ...
    static {
        try {
            ...
            vepres_ton1_files = new ArrayList<URL>(Arrays.asList(
                    ...
                    new File("C:\\Users\\kloeblel\\Desktop\\perso\\partitions_lili\\ton_1\\lucernaire_ton1.pdf").toURI().toURL(),
                    ...
                    new File("C:\\Users\\kloeblel\\Desktop\\perso\\partitions_lili\\ton_1\\prokimeinon_vepres_ton1.pdf").toURI().toURL(),
                    ...
                    new File("C:\\Users\\kloeblel\\Desktop\\perso\\partitions_lili\\ton_1\\apolytikion_ton1.pdf").toURI().toURL(),
    ...
    static List<URL> files = matines_ton3_files;
    static final String FILE_NAME = MATINES_TON3;
