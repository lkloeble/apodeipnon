...
public class GraphicStartOldAPP {}   /*extends Application implements EventHandler<KeyEvent> {
    ...
    private static final String VERSION = "VERSION-31082018-2050";
    ...
    public void handle(KeyEvent e)
    {
        ...
        if(inputPhase.isNeumesPhase()) {
            updateNeumesInputPhase(mappedKeyCode,allBlocks.getBlockId());
            drawNeumesInterface();
    ...
    private void updateNeumesInputPhase(String keyCode, Long blockId) {
        if (keyCode.equals("I")) {
            drawIson();
        }
