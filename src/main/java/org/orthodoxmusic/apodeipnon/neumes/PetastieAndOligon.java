...
public class PetastieAndOligon extends Neume {

    private static int PETASTIE_ISON_LENGTH = 71;

    public PetastieAndOligon() {
        height = 35;
